...
public class UserController {
	...
	public String getUsee(UserVO user,Model model) {
		model.addAttribute("user",service.getUser(user));
		return "user/user";
	}
	// 파일 다운
	@RequestMapping("/filedown")
	public void fildown(HttpServletResponse response, HttpServletRequest request, @RequestParam String uFile)
			throws IOException {
